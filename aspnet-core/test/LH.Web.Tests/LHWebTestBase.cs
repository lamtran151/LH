...
{
    public abstract class LHWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LHWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LHWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LHDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LHDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LHDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LHDbContext, Task<T>> func)
        {
            T result;
