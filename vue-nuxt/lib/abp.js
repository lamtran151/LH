...
(function () {
    ...
    abp.utils.createSvgElement = function (svgHtml) {
        const div = document.createElement("div");
        div.innerHTML = svgHtml.trim();
        return div.firstChild;
    }

    abp.utils.createButton = function (className, name, svgHtml, callback) {
        const button = document.createElement("a");
        button.className = "flex items-center mr-3 " + className;
        button.textContent = name;
        button.addEventListener("click", callback);
        let buttonElement = abp.utils.createSvgElement(svgHtml);
        if (buttonElement) {
            button.insertBefore(buttonElement, button.firstChild);
        }
        return button
    }
